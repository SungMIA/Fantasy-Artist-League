...
=======
// firebase.firestore().collection("users").get().then(function (input) {
>>>>>>> 80330feca5e18987e86479db16506625c5d98bee
...
var matches = autocomplete.search(document.getElementById("userInput").value.toString());
console.log(matches);